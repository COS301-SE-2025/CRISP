...
- **[Functional Requirements (SRS) Document](https://github.com/COS301-SE-2025/CRISP/blob/documents/SRS.md)** - Detailed system requirements and specifications **NBNB please update(2025-08-18) need updated diagrams, Diaan Check asb die ArchitectureDiagram se documentation**
...
- **[Coding standards document](https://github.com/COS301-SE-2025/CRISP/blob/documents/Coding_standards.pdf)** - **Update the file structure (2025-08-18)**

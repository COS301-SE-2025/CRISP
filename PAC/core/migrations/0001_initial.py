# Generated by Django 4.2.10 on 2025-07-07 07:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_type', models.CharField(choices=[('university', 'University'), ('college', 'College'), ('school', 'School'), ('government', 'Government'), ('commercial', 'Commercial'), ('research', 'Research Institution'), ('ngo', 'Non-Governmental Organization')], default='university', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owned_threat_feeds', to='core.organization')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, unique=True)),
                ('level', models.CharField(choices=[('complete', 'Complete Trust'), ('high', 'High Trust'), ('medium', 'Medium Trust'), ('low', 'Low Trust'), ('none', 'No Trust')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('organization', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='publication_feeds', to='core.organization')),
                ('threat_feed', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='publication_feeds', to='core.threatfeed')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('relationship_type', models.CharField(choices=[('partnership', 'Partnership'), ('vendor', 'Vendor Relationship'), ('educational', 'Educational Partnership'), ('research', 'Research Collaboration'), ('institutional', 'Institutional Trust'), ('government', 'Government Agency')], default='partnership', max_length=50)),
                ('is_active', models.BooleanField(default=True)),
                ('notes', models.TextField(blank=True, null=True)),
                ('created_by', models.CharField(default='System', max_length=255)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('source_organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trust_relationships_as_source', to='core.organization')),
                ('target_organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trust_relationships_as_target', to='core.organization')),
                ('trust_level', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.trustlevel')),
            ],
            options={
                'ordering': ['-created_at'],

...
class ThreatFeedSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'taxii_api_root', 'taxii_username', 'taxii_password', 'last_sync', 'last_consumed', 'is_external', 'is_active'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at', 'last_sync', 'last_consumed']
        extra_kwargs = {

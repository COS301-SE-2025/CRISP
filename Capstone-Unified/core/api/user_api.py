...
from core.models.models import CustomUser, Organization, UserInvitation
...
def change_username(request, user_id):
    ...
    POST /api/users/{user_id}/change_username/
    Body: {
        "username": "string"
    }
    """
    try:
        ...
        user_service = UserService()
        result = user_service.change_username(
            user_id=user_id,
        ...
        logger.error(f"Error changing username for user {user_id}: {str(e)}")
        return Response({
            'success': False,

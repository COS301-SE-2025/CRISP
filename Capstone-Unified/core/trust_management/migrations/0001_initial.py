...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("core", "0002_alter_authenticationlog_user_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["level"], name="trust_manag_level_c03efa_idx"),
        ),
        migrations.AddIndex(
            model_name="trustlevel",
            index=models.Index(
                fields=["numerical_value"], name="trust_manag_numeric_d8d302_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="trustlevel",
            index=models.Index(
                fields=["is_active"], name="trust_manag_is_acti_4fa269_idx"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["source_organization"], name="trust_manag_source__2dc0ef_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="trustrelationship",
            index=models.Index(
                fields=["target_organization"], name="trust_manag_target__e67112_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="trustrelationship",
            index=models.Index(fields=["status"], name="trust_manag_status_340bbe_idx"),
        ),
        migrations.AddIndex(
            model_name="trustrelationship",
            index=models.Index(
                fields=["trust_level"], name="trust_manag_trust_l_ed5b58_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="trustrelationship",
            index=models.Index(
                fields=["is_active"], name="trust_manag_is_acti_066c8f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="trustrelationship",
            index=models.Index(
                fields=["valid_from"], name="trust_manag_valid_f_06c005_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="trustrelationship",
            index=models.Index(
                fields=["valid_until"], name="trust_manag_valid_u_76b8d6_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="trustlog",
            index=models.Index(
                fields=["action", "-timestamp"], name="trust_manag_action_8974f9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="trustlog",
            index=models.Index(
                ...
                name="trust_manag_source__39076f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="trustlog",
            index=models.Index(
                ...
                name="trust_manag_target__8f7be1_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="trustlog",
            index=models.Index(
                fields=["user", "-timestamp"], name="trust_manag_user_id_f8c99c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="trustlog",
            index=models.Index(
                fields=["success", "-timestamp"], name="trust_manag_success_bc670e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="trustgroupmembership",
            index=models.Index(
                fields=["organization"], name="trust_manag_organiz_c6b749_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="trustgroupmembership",
            index=models.Index(
                fields=["is_active"], name="trust_manag_is_acti_19234b_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="trustgroupmembership",
        ...
        migrations.AddIndex(
            model_name="trustgroup",
            index=models.Index(
                fields=["group_type"], name="trust_manag_group_t_e0d2bb_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="trustgroup",
            index=models.Index(
                fields=["is_public"], name="trust_manag_is_publ_756495_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="trustgroup",
            index=models.Index(
                fields=["is_active"], name="trust_manag_is_acti_928c35_idx"
            ),
        ),
    ]

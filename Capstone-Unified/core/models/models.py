...
class SystemActivity(models.Model):
    ...
    category = models.CharField(max_length=20, choices=ACTIVITY_CATEGORIES, default='system')
    title = models.CharField(max_length=255)
    description = models.TextField(blank=True, null=True)
    
    # Optional relationships
    threat_feed = models.ForeignKey('ThreatFeed', on_delete=models.CASCADE, blank=True, null=True)
    ...
    @classmethod
    def log_activity(cls, activity_type, title, description=None, threat_feed=None, indicator=None, metadata=None):

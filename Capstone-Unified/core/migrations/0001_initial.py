...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="authenticationlog",
            index=models.Index(
                fields=["user", "-timestamp"], name="core_authen_user_id_194756_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="authenticationlog",
        ...
        migrations.AddIndex(
            model_name="customuser",
            index=models.Index(
                fields=["organization"], name="core_custom_organiz_7b1951_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customuser",
            index=models.Index(
                fields=["is_active"], name="core_custom_is_acti_6cc4d8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customuser",
            index=models.Index(
                fields=["is_verified"], name="core_custom_is_veri_52a4e1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customuser",

...
user_urlpatterns = [
    ...
    path('<uuid:user_id>/delete/', user_api.delete_user, name='user_delete'),
...
organization_urlpatterns = [
    ...
    path('<uuid:organization_id>/delete/', organization_api.delete_organization, name='organization_delete'),

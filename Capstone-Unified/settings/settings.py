...
# SSL and HTTPS settings for production
SECURE_SSL_REDIRECT = not DEBUG and os.getenv('ENABLE_SSL_REDIRECT', 'False').lower() == 'true'
...
# PERFORMANCE: Whitenoise compression and caching
...
OTX_SETTINGS = {
    ...
    'BATCH_SIZE': int(os.getenv('OTX_BATCH_SIZE', '100')),  # Optimized to 100 for performance
...
# PERFORMANCE OPTIMIZATION: Django Cache Configuration with Redis
CACHES = {
    'default': {
        ...
        'OPTIONS': {
            ...
            'IGNORE_EXCEPTIONS': True,  # Don't fail if Redis is down, just skip cache
        },
        'KEY_PREFIX': 'crisp',
...
CACHE_MIDDLEWARE_KEY_PREFIX = 'crisp'

# Generated by Django 4.2.10 on 2025-08-12 18:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domain', models.CharField(help_text="Organization's domain (e.g., university.edu)", max_length=255, unique=True)),
                ('contact_email', models.EmailField(help_text='Primary contact email for the organization', max_length=254)),
                ('website', models.URLField(blank=True, help_text="Organization's website URL")),
                ('organization_type', models.CharField(choices=[('educational', 'Educational'), ('government', 'Government'), ('private', 'Private')], default='educational', help_text='Type of organization (educational, government, private)', max_length=100)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.CharField(blank=True, help_text='User who created this organization', max_length=255, null=True)),
            ],
            options={
                'verbose_name': 'Organization',
                'verbose_name_plural': 'Organizations',
                'ordering': ['name'],
                'indexes': [models.Index(fields=['domain'], name='user_manage_domain_e74ab6_idx'), models.Index(fields=['is_active'], name='user_manage_is_acti_0fa37c_idx'), models.Index(fields=['is_publisher'], name='user_manage_is_publ_d22971_idx'), models.Index(fields=['organization_type'], name='user_manage_organiz_87c267_idx')],
            },
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', '-created_at'], name='user_manage_user_id_315cf0_idx'), models.Index(fields=['is_active'], name='user_manage_is_acti_18e03d_idx'), models.Index(fields=['expires_at'], name='user_manage_expires_7265ac_idx')],
            },
        ),
        migrations.CreateModel(
            name='TrustedDevice',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='authentication_logs', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Authentication Log',
                'verbose_name_plural': 'Authentication Logs',
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['user', '-timestamp'], name='user_manage_user_id_1f6342_idx'), models.Index(fields=['action', '-timestamp'], name='user_manage_action_a04e71_idx'), models.Index(fields=['ip_address', '-timestamp'], name='user_manage_ip_addr_14ddd5_idx'), models.Index(fields=['success', '-timestamp'], name='user_manage_success_a360a2_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='customuser',
        ...
        migrations.AddIndex(
            model_name='customuser',
            index=models.Index(fields=['organization'], name='user_manage_organiz_800725_idx'),
        ),
        migrations.AddIndex(
            model_name='customuser',
            index=models.Index(fields=['is_active'], name='user_manage_is_acti_1defd6_idx'),
        ),
        migrations.AddIndex(
            model_name='customuser',
            index=models.Index(fields=['is_verified'], name='user_manage_is_veri_3fc925_idx'),
        ),
        migrations.AddIndex(
            model_name='customuser',

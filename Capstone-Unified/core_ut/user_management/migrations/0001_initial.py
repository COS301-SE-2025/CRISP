# Generated by Django 4.2.23 on 2025-08-11 19:46
...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="ut_user_management.organization",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "-created_at"], name="ut_user_man_user_id_88516e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="usersession",
            index=models.Index(
                fields=["is_active"], name="ut_user_man_is_acti_486900_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="usersession",
            index=models.Index(
                fields=["expires_at"], name="ut_user_man_expires_41823f_idx"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="authenticationlog",
            index=models.Index(
                fields=["user", "-timestamp"], name="ut_user_man_user_id_11fd23_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="authenticationlog",
            index=models.Index(
                fields=["action", "-timestamp"], name="ut_user_man_action_123065_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="authenticationlog",
            index=models.Index(
                ...
                name="ut_user_man_ip_addr_77650f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="authenticationlog",
            index=models.Index(
                fields=["success", "-timestamp"], name="ut_user_man_success_1a44e1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customuser",

...
from core.api.threat_feed_views import threat_activity_chart_data, recent_activities
...
urlpatterns = [
    ...
    path('api/system-health/', system_health, name='system-health-api'),
    path('api/recent-activities/', recent_activities, name='recent-activities-api'),
]